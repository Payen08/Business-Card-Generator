...
const ContactRow = ({
  ...
  <div className="flex items-baseline">
    ...
    <div className={`${labelWidthClass} flex items-baseline shrink-0 select-none`}>
      {/* Chinese Label: Reduced to 5pt */}
      <span className="text-[#111] font-normal text-[5pt] leading-none">{labelCN}</span>

      {/* Inner Separator - Text Pipe */}
      <span className="mx-[1mm] text-[#C0392B] text-[5pt] font-light leading-none relative top-[-0.3px] opacity-90">|</span>

      {/* English Label: Reduced to 4pt */}
      <span className="text-[#555] font-normal text-[4pt] leading-none">{labelEN}</span>
    </div>

    {/* Outer Separator - Text Pipe (Replaced div to match Inner Separator exactly) */}
    <span className="mr-[2mm] ml-[1mm] text-[#C0392B] text-[5pt] font-light leading-none relative top-[-0.3px] opacity-90 select-none">|</span>

    {/* Value Block */}
    <div className="flex flex-col justify-center">
      {/* Value: Reduced to 5pt */}
      <span className="text-[#000] leading-none font-normal text-[5pt] tracking-wide">{value}</span>
      {/* SubValue: Reduced to 4pt */}
      {subValue && <span className="text-gray-500 text-[4pt] leading-tight mt-[0.3mm] tracking-normal">{subValue}</span>}
    </div>
  </div>
);
      ...
      <div className="flex-1 overflow-y-auto p-10 flex flex-col items-center justify-start print-area bg-[#e5e7eb]">
        ...
        <div ref={frontCardRef} className="business-card bg-white relative shadow-2xl print:shadow-none mb-10 overflow-hidden text-[#1a1a1a]">
          ...
          <div className="absolute top-[12mm] left-[6mm] z-10 grid grid-cols-[auto_auto_auto] gap-x-[1.5mm] gap-y-[1.5mm]">
            ...
            <div className="text-[17pt] font-bold leading-none tracking-wide text-black self-end">
              {data.nameCN}
            </div>
            <div className="self-end mb-[1px]">
              <div className="h-[5mm] w-[1px] bg-gray-300"></div>
            </div>
            <div className="text-[11pt] text-[#C0392B] font-medium leading-none self-end mb-[1px]">
              {data.titleCN}
            </div>

            {/* Row 2: EN Name, Separator, Title */}
            <div className="text-[9pt] font-normal leading-none text-black self-start">
              {data.nameEN}
            </div>
            <div className="self-start">
              <div className="h-[3mm] w-[1px] bg-gray-200"></div>
            </div>
            <div className="text-[8pt] text-[#C0392B] font-normal leading-none self-start">
              {data.titleEN}
            </div>
          </div>
